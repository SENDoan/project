        ...
        <div class="navbar navbar-fixed-top navbar-default">
            ...
            <div class="collapse navbar-collapse text-uppercase" id="navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li class="nav-active"><a href="#">Đặt vé</a></li>
                        ...
                        <div class="col-sm-3">
                            ...
                            <select  name="txtFrom" class="form-control list-unstyled">
                                @foreach($locations as $location)
                                    <option class="li-locations" value="{{ $location->Location_ID }}">{{$location->Name}}({{$location->Location_ID}})</option>
                                @endforeach
                            </select>
                            ...
                            <h5>Điểm đến</h5>
                            <select class="form-control list-unstyled" name="txtTo">
                                @foreach($locations as $location)
                                    <option class="li-locations" value="{{ $location->Location_ID }}">{{$location->Name}}({{$location->Location_ID}})</option>
                                @endforeach
                            </select>
